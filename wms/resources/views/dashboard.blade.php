...
<head>
  ...
  <!-- General CSS Files -->
  <link rel="stylesheet" href="{{ asset('assets/modules/bootstrap/css/bootstraop.min.css') }}">
  <link rel="stylesheet" href="{{ asset('assets/modules/fontaweseome/css/all.min.css') }}">
